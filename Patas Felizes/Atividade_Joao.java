/*Para elaborar esse código, utilizei alguns vídeos de apoio
e debate entre colegas sobre o que deveria ser feito*/
...
public class Atividade {
    ...
    public static void main(String[] args) {
        ...
        Animal cachorro = new Cachorro("Fred", 4, "Saudável");
        Animal gato = new Gato("Emily", 2, "Vacinado");
        abrigo.adicionarAnimal(cachorro);
        abrigo.adicionarAnimal(gato);
        abrigo.listarAnimais();
        cachorro.emitirSom();
        gato.emitirSom();
        abrigo.adotarAnimal("Fred");
        abrigo.listarAnimais();
    }
}